...
export const LIVE_CHAMPION_PROFILE: LiveChampionProfile = {
  ...
  source: "trained",
  approved: true,
  promotedAt: "2026-08-07T20:11:43.195Z",
  benchmarkMatchesPerOpponent: 28,
  winRateVsHeuristic: 0.571429,
  winRateVsChampion: 0.571429,
  averageHpEdge: 6.369048,
  campaignScoreVsHeuristic: 166.5,
  campaignScoreVsChampion: 143.75,
  campaignBossReachVsHeuristic: 0.875,
  campaignBossReachVsChampion: 0.875,
  searchDepth: 3,
  beamWidth: 12,
  weights: {
    hpDiff: 94.88315,
